...
## Project Structure
    ...
    ├── open_organization_38153  # Django project configurations
...
1. Clone this repo and `cd open_organization_38153`
...
2. Clone this repo and `cd open_organization_38153`
